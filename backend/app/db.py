...
ModelArtifact=entity('model_artifacts','model_artifact_id',dict(model_version_id=F('model_versions','model_version_id'),format=S(),precision=S(),hardware_profile=S(),sha256=S(),size_bytes=I(),storage_key=S(),input_shape=J(list),class_map=J(),compatibility=J(),status=S('ready')))
